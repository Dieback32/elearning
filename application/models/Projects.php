...
class Projects extends CI_Model
{
    ...
    public function prelimRemarks($student_id,$group_id,$remarks){
        ...
        if ($check->row()->status == 'Drop'){
            ...
            $this->db->where($check);
            $this->db->update('prelim',$pro_prelim);
...
//                Inserting in Grading Sheet
    ...
    public function midtermRemarks($student_id,$group_id,$remarks){
        $check = $this->db->get_where('students_group',array(
            'group_id' => $group_id,
            'student_id' => $student_id
        ));
...
//                Inserting in Grading Sheet
    ...
    public function prefinalRemarks($student_id,$group_id,$remarks){
        $check = $this->db->get_where('students_group',array(
            'group_id' => $group_id,
            'student_id' => $student_id
        ));
    ...
    public function finalRemarks($student_id,$group_id,$remarks){
        $check = $this->db->get_where('students_group',array(
            'group_id' => $group_id,
            'student_id' => $student_id
        ));
...
//                Inserting in Grading Sheet
    ...
    public function deadline($id){
        $query = $this->db->get_where('project_deadline',array(
            'subject_id' => $id
        ));
        return $query->result();
    ...
    public function setDeadlinePrelim($subject_id,$group_id,$deadline){
        $query = $this->db->get_where('project_deadline',array(
            'group_id' => $group_id,
            'term' => 'prelim',
        ));
        ...
        if ($query->num_rows() == 0){
            $this->db->insert('project_deadline',$data);
        }else{
            $check = array(
                'group_id' => $group_id,
                'term' => 'prelim'
            ...
            $this->db->where($check);
            $this->db->update('project_deadline',$data);
        }

    }

    public function setDeadlineMidterm($subject_id,$group_id,$deadline){
        $query = $this->db->get_where('project_deadline',array(
            'group_id' => $group_id,
            'term' => 'midterm',
        ));
    ...
    public function setDeadlinePrefinal($subject_id,$group_id,$deadline){
        $query = $this->db->get_where('project_deadline',array(
            'group_id' => $group_id,
            'term' => 'prefinal',
        ));
    ...
    public function setDeadlineFinals($subject_id,$group_id,$deadline){
        $query = $this->db->get_where('project_deadline',array(
            'group_id' => $group_id,
            'term' => 'finals',
        ));
