<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>Final Grade Reports for <?php echo $subjects[0]->subject_desc;?></h2>
            </div>
            <div class="body">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <?php foreach ($students as $stud){ ?>
                            <?php foreach ($grades as $data){?>
                                <?php if ($stud->id == $data->student_id){?>
                                    <tr>
                                        <td><?php echo $stud->lastname?>,&nbsp;<?php echo $stud->firstname;?></td>
                                        <td><?php echo $data->prelim;?></td>
                                        <td><?php echo $data->midterm;?></td>
                                        <td><?php echo $data->prefinal;?></td>
                                        <td><?php echo $data->finals;?></td>
                                        <td><?php echo $data->average;?>&nbsp;/&nbsp;<?php echo $data->gwa;?></td>
